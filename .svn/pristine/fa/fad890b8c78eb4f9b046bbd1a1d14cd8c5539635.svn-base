...
/**
 * Builder for {@link com.facebook.messenger.ShareToMessengerParams}.
 */
public class ShareToMessengerParamsBuilder {
  ...
  /**
   * Gets the mime type of the content. See {@link com.facebook.messenger.ShareToMessengerParams#VALID_MIME_TYPES} for
