...
public class GraphRequestBatch extends AbstractList<GraphRequest> {
     ...
     * @throws com.facebook.FacebookException        If there was an error in the protocol used to communicate
     *                                  with the service
     ...
     * {@link com.facebook.GraphRequest#setCallback(com.facebook.GraphRequest.Callback)})
     * <p/>
     ...
     * using {@link com.facebook.FacebookSdk#setOnProgressThreshold(long)}.
     */
