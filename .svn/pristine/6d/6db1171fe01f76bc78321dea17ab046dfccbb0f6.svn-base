...
public final class SharePhotoContent
    ...
    /**
     * Photos to be shared.
     * @return {@link java.util.List} of {@link com.facebook.share.model.SharePhoto}s.
     */
    @Nullable
    ...
    public static class Builder extends ShareContent.Builder<SharePhotoContent, Builder> {
         ...
         * @param photos {@link java.util.List} of {@link SharePhoto}s
         *                                      to add.
         * @return The builder.
         */
         ...
         * @param photos {@link java.util.List} of {@link SharePhoto}s to add.
         * @return The builder.
         */
